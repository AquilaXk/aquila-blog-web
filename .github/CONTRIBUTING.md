...
1. Search our repository for open or closed [Pull Requests](https://github.com/AquilaXk/aquila-blog-web/pulls) that relate to your submission. You don't want to duplicate effort.
2. Fork the project.
...
6. [Open a Pull Request](https://github.com/AquilaXk/aquila-blog-web/compare?expand=1).
