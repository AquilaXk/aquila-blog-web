...
test.describe("editor studio state", () => {
  ...
  test("editor studio는 v2 단일 경로와 단일 작성 모드 계약을 유지한다", () => {
    ...
    expect(blockEditorEngineSource).toContain('from "./blockToolbarModel"')
    ...
    expect(blockEditorEngineSource).toContain('runInlineMarkCommand(editor, "bold")')
    expect(blockEditorEngineSource).toContain('runInlineMarkCommand(editor, "italic")')
    expect(blockEditorEngineSource).toContain('runInlineMarkCommand(editor, "strike")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(currentEditor, "heading-2")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(currentEditor, "heading-3")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(currentEditor, "ordered-list")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(currentEditor, "bullet-list")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(currentEditor, "quote")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(editor, "heading-1")')
    expect(blockEditorEngineSource).toContain('runBlockToolbarCommand(editor, "bullet-list")')
    expect(blockEditorEngineSource).toContain("isToolbarBlockInsertActive(editor, item.id)")
    expect(blockEditorEngineSource).toContain("runInlineCode(editor)")
    expect(blockEditorEngineSource).toContain("runInlineColor(editor, color)")
  ...
  test("table resize metadata와 상세 렌더 계약은 colgroup width와 drag guide를 유지한다", () => {
    ...
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-column-drag-guide"')
    expect(blockEditorEngineLayersSource).toContain('data-testid={`table-column-resize-boundary-${index}`}')
    ...
    expect(blockEditorEngineLayersSource).toContain('import { createPortal } from "react-dom"')
    expect(blockEditorEngineLayersSource).toContain("const tableOverlay = (")
    expect(blockEditorEngineLayersSource).toContain("createPortal(tableOverlay, document.body)")
    ...
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-corner-grow-handle"')
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-corner-preview-outline"')
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-structure-menu-button"')
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-cell-menu-button"')
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-overflow-mode-normal"')
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-overflow-mode-wide"')
    ...
    expect(blockEditorEngineLayersSource).toContain('data-testid="table-row-drag-shadow"')
    expect(blockEditorEngineLayersSource).toContain('"table-row-reorder-indicator"')
    expect(blockEditorEngineLayersSource).toContain('"table-column-reorder-indicator"')
    ...
    expect(blockEditorEngineLayersSource).toContain("activeTableStructureState.hasHeaderRow")
    expect(blockEditorEngineLayersSource).toContain("activeTableStructureState.hasHeaderColumn")
    ...
    expect(blockEditorEngineLayersSource).toContain("data-column-step={tableCornerGrowStepMetrics.columnStepPx}")
    expect(blockEditorEngineLayersSource).toContain("data-row-step={tableCornerGrowStepMetrics.rowStepPx}")
    expect(blockEditorEngineLayersSource).toContain('aria-label="표 구조 메뉴"')
    expect(blockEditorEngineLayersSource).toContain("페이지 너비에 맞춤")
    expect(blockEditorEngineLayersSource).toContain("넓은 표")
    expect(blockEditorEngineLayersSource).toContain("제목 행")
    expect(blockEditorEngineLayersSource).toContain("제목 열")
