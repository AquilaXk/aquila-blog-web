...
test("상세 본문은 inline color 토큰과 blockquote soft line break를 그대로 노출하지 않는다", async ({ page }) => {
  ...
  await expect(page.locator(".aq-inline-color").filter({ hasText: '"어디에"' })).toBeVisible()
