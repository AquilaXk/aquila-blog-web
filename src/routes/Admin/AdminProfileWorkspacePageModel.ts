...
export type ReadyProfileWorkspaceProps = Omit<AdminProfileWorkspacePageProps, "initialWorkspace"> & {
  initialWorkspace: ProfileWorkspaceResponse
  workspaceQuery: ReturnType<typeof useProfileWorkspace>
}
