...
export const renderAdminProfileWorkspaceSection = (props: Record<string, any>) => {
  const { activeSection, linkTab, setLinkTab, draggingLinkIndex, setDraggingLinkIndex, dragOverLinkIndex, setDragOverLinkIndex, dragOverLinkPosition, setDragOverLinkPosition, openIconPicker, setOpenIconPicker, loadingKey, displayNameInput, setDisplayNameInput, draft, sessionMember, updateDraft, updateLinkItem, appendLinkItem, removeLinkItem, moveLinkItem, reorderLinkItems, updateAboutSection, addAboutSection, removeAboutSection, moveAboutSection, addAboutItem, removeAboutItem, moveAboutItem, updateAboutProject, addAboutProject, removeAboutProject, moveAboutProject, profileImageFileName, setIsProfileImageEditorOpen } = props as Record<string, any> & { draft: ProfileWorkspaceContent; visibleLinks: ProfileCardLinkItem[] }
