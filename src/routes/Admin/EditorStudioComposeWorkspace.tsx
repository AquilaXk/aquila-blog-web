...
export const EditorStudioComposeWorkspace = ({ isCompactMobileLayout, isPublishModalOpen, mobilePrimaryStatus, mobileSecondaryStatusText, mobilePrimaryActionLabel, composeCallToActionLabel, mobilePrimaryActionDisabled, onPrimaryAction, currentVisibilityText, editorModeLabel, composePageTitle, composeSurfaceSubtitle, composeStatusText, composeStatusTone, postSummary, postSummaryMaxLength, onPostSummaryChange, postTags, tagDraft, onTagDraftChange, onAddTags, onAddTag, onRemoveTag, titleInputRef, postTitle, onPostTitleChange, onPostTitleKeyDown, thumbnailImageFileInputRef, onThumbnailImageFileChange, contentLength, lineCount, imageCount, editorCanvas, tagSummaryText, isSaveDraftDisabled, onSaveLocalDraft, composeHeroSummary, composeStatusEntries, activeVisibility, visibilityOptions, onVisibilityChange, previewViewport, previewViewportLabel, previewViewportOptions, onPreviewViewportChange, previewFrameStyle, previewThumbnailSrc, postThumbnailFocusX, postThumbnailFocusY, postThumbnailZoom, onPreviewThumbnailError, previewVisibilityLabel, summaryPreview, previewDateText, previewAuthorAvatarSrc, displayNameInitial, displayName, summaryLengthLabel, isComposeAssistOpen, onToggleComposeAssist, thumbnailEditorPanel, previewMetaEditorPanel, isTagPanelOpen, onToggleTagPanel, isUtilityPanelOpen, onToggleUtilityPanel, metaNotice, knownTags, tagUsageMap, onToggleKnownTag, onDeleteKnownTag, onRestoreLocalDraft, onClearLocalDraft, isClearLocalDraftDisabled, }: EditorStudioComposeWorkspaceProps) => (<ComposeSurfaceSection>
    <EditorSection>
      ...
      <ComposeStudioLayout>
        <EditorStudioComposeWritingSurface editorModeLabel={editorModeLabel} composePageTitle={composePageTitle} composeSurfaceSubtitle={composeSurfaceSubtitle} composeStatusText={composeStatusText} composeStatusTone={composeStatusTone} currentVisibilityText={currentVisibilityText} postSummary={postSummary} postSummaryMaxLength={postSummaryMaxLength} onPostSummaryChange={onPostSummaryChange} postTags={postTags} tagDraft={tagDraft} onTagDraftChange={onTagDraftChange} onAddTags={onAddTags} onAddTag={onAddTag} onRemoveTag={onRemoveTag} titleInputRef={titleInputRef} postTitle={postTitle} onPostTitleChange={onPostTitleChange} onPostTitleKeyDown={onPostTitleKeyDown} thumbnailImageFileInputRef={thumbnailImageFileInputRef} onThumbnailImageFileChange={onThumbnailImageFileChange} contentLength={contentLength} lineCount={lineCount} imageCount={imageCount} editorCanvas={editorCanvas} tagSummaryText={tagSummaryText} isSaveDraftDisabled={isSaveDraftDisabled} onSaveDraft={onSaveLocalDraft} primaryActionDisabled={mobilePrimaryActionDisabled} primaryActionLabel={composeCallToActionLabel} onPrimaryAction={onPrimaryAction}/>
