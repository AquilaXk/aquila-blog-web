...
export const registeredBrowserStorageKeys: BrowserStorageRegistryEntry[] = [
  ...
  },
  {
    ...
    required: false,
    retention: "migrated once into create.v2 then removed",
    deletion: "one-time migration to admin.editor.localDraft.create.v2 or browser storage deletion",
  ...
  },
  {
    ...
    stores: "create-context draft title, markdown, summary, thumbnail, tags, category, visibility, source, savedAt",
  },
  {
    area: "localStorage",
    ...
    stores: "per-post draft title, markdown, summary, thumbnail, tags, category, visibility, source, savedAt",
  },
  {
    area: "localStorage",
