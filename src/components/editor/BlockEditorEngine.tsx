  ...
  return (
    <Shell className={className}>
      <BlockEditorToolbarLayer
        ...
        inlineColorMenuRef={inlineColorMenuRef}
        isInlineCodeActive={isInlineCodeActive}
        isInlineColorMenuOpen={isInlineColorMenuOpen}
        isToolbarMoreOpen={isToolbarMoreOpen}
        setIsInlineColorMenuOpen={setIsInlineColorMenuOpen}
        setIsToolbarMoreOpen={setIsToolbarMoreOpen}
        toolbarActions={toolbarActions}
        toolbarMoreActions={toolbarMoreActions}
      />
      <BlockEditorQuickInsertLayer
        ...
        isQuickInsertActionDisabled={isQuickInsertActionDisabled}
        quickInsertActions={quickInsertActions}
      />
      <BlockEditorSlashMenuLayer
        disabled={disabled}
        executeSlashCatalogAction={executeSlashCatalogAction}
        flatSlashEntries={flatSlashEntries}
        handleSlashActionPointerMove={handleSlashActionPointerMove}
        handleSlashMenuKeyDown={handleSlashMenuKeyDown}
        isSlashActionDisabled={isSlashActionDisabled}
        isSlashMenuOpen={isSlashMenuOpen}
        selectedSlashIndex={selectedSlashIndex}
        slashInteractionMode={slashInteractionMode}
      ...
      <BlockEditorViewportLayer
        ...
        blockInsertCatalog={blockInsertCatalog}
        blockMenuState={blockMenuState}
        ...
        closeBlockMenus={closeBlockMenus}
        ...
        handleViewportDragOver={handleViewportDragOver}
        handleViewportDragStart={handleViewportDragStart}
        handleViewportDrop={handleViewportDrop}
        handleViewportKeyDownCapture={handleViewportKeyDownCapture}
        ...
        isInlineCodeActive={isInlineCodeActive}
        moveBlockByStep={moveBlockByStep}
        nestedListItemDropIndicatorState={nestedListItemDropIndicatorState}
        onBlockAddClick={handleBlockHandleAddClick}
        onBlockMenuPointerEnter={handleBlockMenuPointerEnter}
        onBlockMenuPointerLeave={handleBlockMenuPointerLeave}
        onCompositionEnd={handleEditorViewportCompositionEnd}
        onCompositionStart={handleEditorViewportCompositionStart}
        onCompositionUpdate={handleEditorViewportCompositionUpdate}
        onHandleRailPointerEnter={handleBlockHandleRailPointerEnter}
        onHandleRailPointerLeave={handleBlockHandleRailPointerLeave}
        ...
        selectedListItemContext={selectedListItemContext}
      ...
      <BlockEditorTableOverlayLayer
        ...
        appendTableAxisAtEnd={appendTableAxisAtEnd}
        canMergeSelectedTableCells={canMergeSelectedTableCells}
        canSplitSelectedTableCell={canSplitSelectedTableCell}
        cancelTableOverflowCoachmarkHide={cancelTableOverflowCoachmarkHide}
        cancelTableQuickRailHide={cancelTableQuickRailHide}
        compactTableAffordanceKind={compactTableAffordanceKind}
        desktopTableRailLayout={desktopTableRailLayout}
        draggedTableAxisState={draggedTableAxisState}
        editor={editor}
        growTableFromCorner={growTableFromCorner}
        handleTableColumnRailSegmentClick={handleTableColumnRailSegmentClick}
        handleTableRowGripClick={handleTableRowGripClick}
        handleToolbarButtonMouseDown={handleToolbarButtonMouseDown}
        hideTableOverflowCoachmark={hideTableOverflowCoachmark}
        hoveredTableCellMenuLayout={hoveredTableCellMenuLayout}
        isCurrentTableColumnSelection={isCurrentTableColumnSelection}
        isCurrentTableRowSelection={isCurrentTableRowSelection}
        isTableCornerGrowActive={isTableCornerGrowActive}
        isTableQuickRailHovered={isTableQuickRailHovered}
        normalizeTableColorInputValue={normalizeTableColorInputValue}
        openSelectionAwareTableMenu={openSelectionAwareTableMenu}
        openTableMenu={openTableMenu}
        resolveTableCornerGrowStepMetricsFromHandle={resolveTableCornerGrowStepMetricsFromHandle}
        runTableMenuEditorAction={runTableMenuEditorAction}
        scheduleTableOverflowCoachmarkHide={scheduleTableOverflowCoachmarkHide}
        scheduleTableQuickRailHide={scheduleTableQuickRailHide}
        shouldPersistTableHandles={shouldPersistTableHandles}
        shouldRenderTableAffordanceOverlay={shouldRenderTableAffordanceOverlay}
        shouldShowCellMergeSection={shouldShowCellMergeSection}
        shouldShowColumnAddBar={shouldShowColumnAddBar}
        shouldShowColumnRail={shouldShowColumnRail}
        shouldShowDesktopTableHandles={shouldShowDesktopTableHandles}
        shouldShowGrowHandle={shouldShowGrowHandle}
        shouldShowRowAddBar={shouldShowRowAddBar}
        shouldShowRowRail={shouldShowRowRail}
        shouldShowStructureMenuButton={shouldShowStructureMenuButton}
        shouldShowTableCellMenu={shouldShowTableCellMenu}
        stabilizeTableSelectionSurface={stabilizeTableSelectionSurface}
        startPendingTableAxisDrag={startPendingTableAxisDrag}
        startTableColumnRailResize={startTableColumnRailResize}
        startTableCornerGrow={startTableCornerGrow}
        tableAffordanceGeometry={tableAffordanceGeometry}
        tableAxisDragGhostPosition={tableAxisDragGhostPosition}
        tableAxisDragSuppressClickRef={tableAxisDragSuppressClickRef}
        ...
        tableCornerGrowRef={tableCornerGrowRef}
        tableCornerGrowStepMetrics={tableCornerGrowStepMetrics}
        tableCornerGrowSuppressClickRef={tableCornerGrowSuppressClickRef}
        ...
        updateActiveTableCellAttrs={updateActiveTableCellAttrs}
        updateActiveTableOverflowMode={updateActiveTableOverflowMode}
      />
      <BlockEditorPreviewLayer
