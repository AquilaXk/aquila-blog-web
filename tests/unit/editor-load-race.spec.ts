...
const ignoreState = (_next: unknown) => undefined
...
const createHarness = (useRealMetaParser = false) => {
  ...
  const params: DraftLifecycleParams = {
    ...
    setPostTags: ignoreState,
    setPostCategory: createSetter(() => "", () => undefined),
    setPostVisibility: ignoreState,
    setKnownTags: ignoreState,
    ...
    setMobileComposeStep: ignoreState,
    ...
    requestTempPostWithConflictRetry: async () => ({ data: { ...createPost("temp", "", ""), id: 1, summarySource: "NONE" as const }, msg: "", resultCode: "200-1" }),
