...
test.describe("language system and translations", () => {
  ...
  test("translations do not contain legacy AI-slop copy", () => {
    ...
    expect(translations.ko.recentPostsSubtitle).toBe("소프트웨어 아키텍처와 엔지니어링 탐구 기록")
    expect(translations.en.recentPostsSubtitle).toBe("Writing on software architecture and systems engineering")
